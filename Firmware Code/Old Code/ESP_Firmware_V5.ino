    ...
    void onWrite(BLECharacteristic *pCharacteristic) {
      ...
      if (rxValue.length() > 0) {
        ...
        if (rxValue.find("SYS_ON") != -1) { 
          ...
          plug_one.setCounter(1,0,0);
          plug_two.setCounter(1,0,0);
          plug_three.setCounter(1,0,0);
        }
...
void get_sensor()
{
  ...
  if(plug_one.getCurrentSeconds() == 0 && plug_one.getCurrentMinutes() == 0 && plug_one.getCurrentHours() == 0) max_cur = 0.00;
